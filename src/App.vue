      ...
      <div class="row">
        <div class="col-lg-4 padded">
          <div class="col-12" style="margin-bottom: 16px">
            <button type="button" class="btn btn-primary" style="width: 100%; background-color: #00acee" v-on:click="sendTweet" >New Tweet <span><</span></button>
          </div>
          <label class="col-lg-12">
            <b-form-textarea no-resize rows="5" class="textarea" v-model="tweet" placeholder="Write your tweet here"></b-form-textarea>
          </label>
        </div>
        <div class="tweets col-lg-8">
          <sse-timeline/>
        </div>
      </div>
    </div>
